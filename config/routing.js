...
{id: 'design-conventions', alias: 'Design Conventions', type: 'category', route: 'design-conventions', items: [
	...
	{id: 'layout', alias: 'Layout', type: 'route', route: 'design-conventions.layout'},
	{id: 'colors', alias: 'Colors', type: 'route', route: 'design-conventions.colors'}
...
{id: 'home-page', alias: 'Home Page', type: 'category', route: 'design-patterns.home-page', items: [
	{id: 'sample-layouts', alias: 'Sample Layouts', type: 'route', route: 'design-patterns.home-page.sample-layouts'}
]}, // 07-home-page
...
{id: 'user-feedback', alias: 'User Feedback', type: 'category', route: 'design-patterns.user-feedback', items: [
	{id: 'confirmation-dialog', alias: 'Confirmation Dialog', type: 'route', route: 'design-patterns.user-feedback.confirmation-dialog'},
	{id: 'notifications', alias: 'Notifications', type: 'route', route: 'design-patterns.user-feedback.notifications'}
]}, // 16-user-feedback
...
{id: 'menu-controls', alias: 'Menu Controls', type: 'category', route: 'UI-components.menu-controls', items: [
	{id: 'navigation', alias: 'Navigation', type: 'route', route: 'UI-components.menu-controls.navigation'},
...
{id: 'indicator-controls', alias: 'Indicator Controls', type: 'category', route: 'UI-components.indicator-controls', items: [
	...
	{id: 'badges', alias: 'Badges', type: 'route', route: 'UI-components.indicator-controls.badges'},
	{id: 'progress-indicators', alias: 'Progress Indicators', type: 'route', route: 'UI-components.indicator-controls.progress-indicators'},
	{id: 'transient-messages', alias: 'Transient Messages', type: 'route', route: 'UI-components.indicator-controls.transient-messages'}
...
{id: 'input-controls', alias: 'Input Controls', type: 'category', route: 'UI-components.input-controls', items: [
	...
	{id: 'modal-dialog-input', alias: 'Modal Dialog Input', type: 'route', route: 'UI-components.input-controls.modal-dialog-input'}
]}, // 04-input-controls
...
{id: 'content-views', alias: 'Content Views', type: 'category', route: 'UI-components.content-views', items: [
	...
	{id: 'sort', alias: 'Sort', type: 'route', route: 'UI-components.content-views.sort'}
]}, // 06-content-views
	{id: 'icons', alias: 'Icons', type: 'route', route: 'UI-components.icons'}
]}, // 06-UI-components
